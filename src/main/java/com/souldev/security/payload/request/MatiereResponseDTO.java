...
public class MatiereResponseDTO {
    ...
    private List<String> filiereIds; // Identifiants des filières associées
    ...
    public List<String> getFiliereIds() {
        return filiereIds;
    }

    public void setFiliereIds(List<String> filiereIds) {
        this.filiereIds = filiereIds;
    }
